...
import com.securepic.securepic.main;
...
public class Login extends AppCompatActivity implements OnCompleteListener<AuthResult> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView.setText("tonismr1@gmail.com");
    ...
    private void attemptLogin() {
        ...
        if (!TextUtils.isEmpty(password) && !isPasswordValid(password)) {
            mPasswordView.setError("La contraseña es corta");
        ...
        if (TextUtils.isEmpty(email)) {
            mEmailView.setError("El campo no puede estar vacio");
            focusView = mEmailView;
            cancel = true;
        } else if (!isEmailValid(email)) {
            mEmailView.setError("El email no es valido");
            focusView = mEmailView;
            cancel = true;
        }
    ...
    public void onComplete(@NonNull Task<AuthResult> task) {
        ...
        if (!task.isSuccessful()) {
           ...
           // Toast.makeText(this, "Se a producido un error", Toast.LENGTH_SHORT).show();
            Snackbar.make(mLoginFormView,  task.getException().getMessage(), Snackbar.LENGTH_LONG).show();
            showProgress(false);
        } else{
